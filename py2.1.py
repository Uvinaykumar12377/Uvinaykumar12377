...
has() --> it creates a hash value for constant datatypes and provides error for non constant datatypes
n1=89+7j
print(hash(n1))
...
#!--> operators
operators are symbols which is used to perform various operation between 2 or more operands
Arithmatic
assignment
logical
...
if age>=18 and nationality=="Indaian":
